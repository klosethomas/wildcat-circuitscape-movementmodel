...
source$source[sites_shape$OBJ_ID == c(71 )] <- sites_shape$area[sites_shape$OBJ_ID == c(71 )]
source$source[sites_shape$OBJ_ID == c(96 )] <- sites_shape$area[sites_shape$OBJ_ID == c(96 )]
