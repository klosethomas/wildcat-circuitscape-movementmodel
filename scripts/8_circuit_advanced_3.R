...
cs_settings <- c(
  ...
  paste(c("ground_file ="),
        paste(
          here("data/output/circuitscape/advanced/3/input/ground_raster.asc"),
          sep = "/"
        )),
  "use_unit_currents = False",
  paste(c("source_file ="),
        paste(
          here("data/output/circuitscape/advanced/3/input/source_raster.asc"),
          sep = "/"
        )),
  ...
  paste(c("output_file ="),
        paste(
          here("data/output/circuitscape/advanced/3/circuitscape_adv_3.out"),
          sep = "/"
        )),
  ...
  paste(c("log_file ="),
        paste(
          here("data/output/circuitscape/advanced/3/log_adv_3.log"),
          sep = "/"
        )),
...
writeLines(cs_settings,
           here("data/output/circuitscape/cs_settings_adv_3.ini"))
...
####################################################################################################
# source = homeranges in the south east
...
source$source[sites_shape$OBJ_ID == c(113)] <- sites_shape$area[sites_shape$OBJ_ID == c(113)]
...
st_write(source,
         here("data/output/circuitscape/advanced/3/input/source_shape.shp"),
         delete_layer = TRUE)
...
ground$area[ground$OBJ_ID == c(71 )] <- NA
ground$area[ground$OBJ_ID == c(96 )] <- NA
ground$area[ground$OBJ_ID == c(5  )] <- NA
ground$area[ground$OBJ_ID == c(125)] <- NA
ground$area[ground$OBJ_ID == c(113)] <- NA
...
st_write(ground,
         here("data/output/circuitscape/advanced/3/input/ground_shape.shp"),
         delete_layer = TRUE)
...
julia_call('compute',
           paste0(input.dir, 'cs_settings_adv_3', ".ini"),
           show_value = TRUE)   
#----------------------------------------------------------------------------------------------
####    VOLTAGE MAP
#load result map
circuitscape_adv_3_voltmap <- raster(here("data/output/circuitscape/advanced/3/circuitscape_adv_3_voltmap.asc"))
homerange_pol <-
  read_sf(here("data/output/homerange_shape/homerange_redefined.shp"))   # as shapefile

#set zero to NA
circuitscape_adv_3_voltmap_zero_NA <- circuitscape_adv_3_voltmap
circuitscape_adv_3_voltmap_zero_NA[circuitscape_adv_3_voltmap_zero_NA == 0] <- NA
crs(circuitscape_adv_3_voltmap_zero_NA) <- crs(homerange_pol)
# Write rasters
writeRaster(circuitscape_adv_3_voltmap_zero_NA,
            here("data/output/circuitscape/advanced/3/circuitscape_adv_3_voltmap_zero_NA.tif"),
            overwrite = TRUE)

# set to procent
circuitscape_adv_3_voltmap_procent <- circuitscape_adv_3_voltmap_zero_NA / maxValue(circuitscape_adv_3_voltmap_zero_NA)*100
# Write rasters
writeRaster(circuitscape_adv_3_voltmap_procent,
            here("data/output/circuitscape/advanced/3/circuitscape_adv_3_voltmap_procent.tif"),
            overwrite = TRUE)

#----------------------------------------------------------------------------------------------
####    CURRENT MAP
#load result map
circuitscape_adv_3_curmap <- raster(here("data/output/circuitscape/advanced/3/circuitscape_adv_3_curmap.asc"))
homerange_pol <-
  read_sf(here("data/output/homerange_shape/homerange_redefined.shp"))   # as shapefile

#set zero to NA
circuitscape_adv_3_curmap_zero_NA <- circuitscape_adv_3_curmap
circuitscape_adv_3_curmap_zero_NA[circuitscape_adv_3_curmap_zero_NA == 0] <- NA
crs(circuitscape_adv_3_curmap_zero_NA) <- crs(homerange_pol)
# Write rasters
writeRaster(circuitscape_adv_3_curmap_zero_NA,
            here("data/output/circuitscape/advanced/3/circuitscape_adv_3_curmap_zero_NA.tif"),
            overwrite = TRUE)
#mask the corridors
circuitscape_adv_3_curmap_masked <- mask(circuitscape_adv_3_curmap_zero_NA, homerange_pol)
writeRaster(circuitscape_adv_3_curmap_masked,
            here("data/output/circuitscape/advanced/3/circuitscape_adv_3_curmap_masked.tif"),
            overwrite = TRUE)



# set to procent
circuitscape_adv_3_curmap_procent <- (circuitscape_adv_3_curmap_zero_NA / sum(source$source))*100
# Write rasters
writeRaster(circuitscape_adv_3_curmap_procent,
            here("data/output/circuitscape/advanced/3/circuitscape_adv_3_curmap_procent.tif"),
            overwrite = TRUE)
# #mask the corridors
circuitscape_adv_3_curmap_procent_masked <- mask(circuitscape_adv_3_curmap_procent, homerange_pol)
writeRaster(circuitscape_adv_3_curmap_procent_masked,
            here("data/output/circuitscape/advanced/3/circuitscape_adv_3_curmap_procent_masked.tif"),
            overwrite = TRUE)
